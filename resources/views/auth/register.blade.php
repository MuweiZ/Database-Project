            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="gender" class="col-md-4 col-form-label text-md-right">{{ __('Gender(M/F representing Male/Female. Not required.)') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="marital_status" class="col-md-4 col-form-label text-md-right">{{ __('Marital Status(M/S/W representing Married/Single or Widow/Widower)') }}</label>
